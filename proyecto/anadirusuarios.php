    ...
    array_key_exists('password',$_POST)) {
        ...
        if ($_POST['username']=='') {
            ...
            if (mysqli_num_rows($result)>0) {
                ...
                $cifrada = md5($contra);
                $query="INSERT INTO usuarios (username, password, rol) VALUES('".mysqli_real_escape_string($enlace,$_POST['username'])."','".$cifrada."', (SELECT id_rol FROM roles WHERE roles.rol='".mysqli_real_escape_string($enlace,$_POST['rol'])."'))";
