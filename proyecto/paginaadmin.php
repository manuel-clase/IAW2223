  ...
  ';
    if ($resultado->num_rows > 0) {
        ...
        while($fila = $resultado->fetch_assoc())
            ...
            <td class='text-center'> <a href='veradmin.php?incidencia_id={$fila["id"]}' class='btn btn-primary'> <i class='bi bi-eye'></i> Ver</a> </td>
    ...
    echo "</tbody></table> <br> <p><a href='loginproyecto.php?Logout=1' class='btn btn-secondary'>Cerrar sesión</a></p>";
...
<a href="https://iawmanuelarcos-com.stackstaging.com/proyecto/insert.php" class='btn btn-secondary'>Haz click aquí para llegar al menu de insertar filas.</a>
<div>
<div class="container text-center mt-5">
      <a href="https://iawmanuelarcos-com.stackstaging.com/proyecto/anadirusuarios.php" class="btn btn-warning mt-5"> Haga click para anadir usuarios </a>
<div>
<div class="container text-center mt-5">
<a href="https://iawmanuelarcos-com.stackstaging.com/proyecto/usuarios.php" class='btn btn-secondary'>Haz click aquí para llegar al menu de usuarios.</a>
<div>
