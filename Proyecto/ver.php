...
<?php
  ...
  if (!$enlace) {
    ...
    $query = "SELECT id, planta, aula, descripcion, fecha_de_alta, fecha_de_revision, fecha_de_resolucion, comentario FROM incidencias WHERE id={$idincidencia} LIMIT 1"; // Realizamos la consulta
